...
def _download(
    ...
    if not cache_dir:
        # 优先使用用户主目录下的.cache/clip，避免权限问题
        cache_dir = os.path.expanduser("~/.cache/clip")
        # 如果需要兼容旧路径，可以添加检查逻辑
        # old_cache_dir = os.path.expanduser("/remote-home/iot_zhouqihang/root/.cache/clip")
        # cache_dir = old_cache_dir if os.path.exists(old_cache_dir) else os.path.expanduser("~/.cache/clip")
